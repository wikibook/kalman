...
% process noise
Qd = diag([0 0 1e-2 1e-3 1e-3]); % for UKF 
...
for k = 0:15000
    ...
    % MU
    [xhat, Phat, zhat, S] = vanderpol_ukf_mu(z, xbar, Pbar, Rd, params);
    
    % TU
    [xbar, Pbar] = vanderpol_ukf_tu(xhat, Phat, Qd, dt, params);
